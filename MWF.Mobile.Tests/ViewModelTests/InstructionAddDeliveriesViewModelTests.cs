...
namespace MWF.Mobile.Tests.ViewModelTests
{
        ...
        : MvxIoCSupportingTest
    {
        ...
        protected override void AdditionalSetup()
        {
            ...
            _applicationProfileRepoMock.Setup(aprm => aprm.GetAll()).Returns(new List<ApplicationProfile>() { _applicationProfile });
        ...
        public void InstructionAddDeliveriesVM_BuildDeliveriesList_CollectionsOnly()
        {
            ...
            _mockMobileDataRepo.Setup(mdr => mdr.GetNonCompletedInstructions(It.IsAny<Guid>())).Returns(nonCompletedCollectionInstructions);
        ...
        public void InstructionAddDeliveriesVM_BuildDeliveriesList_Deliveries()
        {
            ...
            _mockMobileDataRepo.Setup(mdr => mdr.GetNonCompletedInstructions(It.IsAny<Guid>())).Returns(nonCompletedDeliveryInstructions);

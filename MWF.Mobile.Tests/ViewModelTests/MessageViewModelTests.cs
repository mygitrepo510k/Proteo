...
namespace MWF.Mobile.Tests.ViewModelTests
{
        ...
        : MvxIoCSupportingTest
    {
        ...
        protected override void AdditionalSetup()
        {
            ...
            _mockDataChunkService.Setup(dc => dc.SendDataChunk(It.IsAny<MobileApplicationDataChunkContentActivity>(), It.IsAny<MobileData>(), It.IsAny<Driver>(), It.IsAny<Vehicle>(), It.Is<bool>(i => i == false), It.Is<bool>(i => i == false)));
        ...
        public void MessageVM_Message_ReadButton_Unread()
        {
            ...
            _mockDataChunkService.Verify(dc => dc.SendDataChunk(It.IsAny<MobileApplicationDataChunkContentActivity>(), It.IsAny<MobileData>(), It.IsAny<Driver>(), It.IsAny<Vehicle>(), It.Is<bool>(i => i == false), It.Is<bool>(i => i == false)), Times.Once);
        }
        ...
        public void MessageVM_Message_ReadButton_Read()
        {
            ...
            _mockDataChunkService.Verify(dc => dc.SendDataChunk(It.IsAny<MobileApplicationDataChunkContentActivity>(), It.IsAny<MobileData>(), It.IsAny<Driver>(), It.IsAny<Vehicle>(), It.Is<bool>(i => i == false), It.Is<bool>(i => i == false)), Times.Never);

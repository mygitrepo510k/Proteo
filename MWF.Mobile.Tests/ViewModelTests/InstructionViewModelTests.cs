...
namespace MWF.Mobile.Tests.ViewModelTests
{
        ...
        : MvxIoCSupportingTest
    {
        ...
        public void InstructionVM_ProgressButtonText_NotStarted()
        {
            ...
            _mockMobileDataRepo.Verify(mdr => mdr.Update(It.Is<MobileData>(md => md == _mobileData)), Times.Once);
        ...
        public void InstructionVM_CheckInstructionNotification_Delete()
        {
            ...
            instructionVM.CheckInstructionNotificationAsync(Core.Messages.GatewayInstructionNotificationMessage.NotificationCommand.Delete, _mobileData.ID);
        ...
        public void InstructionVM_CheckInstructionNotification_Update_Confirm()
        {
            ...
            instructionVM.CheckInstructionNotificationAsync(Core.Messages.GatewayInstructionNotificationMessage.NotificationCommand.Update, _mobileData.ID);
